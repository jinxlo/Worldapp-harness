...
export function buildAuthorizeUrl(
  ...
  // clients. `referrer=worldapp` lets xAI attribute WorldApp-originated
...
<html>
  <head>
    <title>WorldApp - xAI Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
...
<html>
  <head>
    <title>WorldApp - xAI Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
      ...
      async loader(getAuth) {
        ...
        return {
          ...
          async fetch(requestInput: RequestInfo | URL, init?: RequestInit) {
            ...
            headers.set("User-Agent", `worldapp/${InstallationVersion}`)
