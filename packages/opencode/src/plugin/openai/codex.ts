...
<html>
  <head>
    <title>WorldApp - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to WorldApp.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>WorldApp - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
...
export async function CodexAuthPlugin(input: PluginInput, options: CodexAuthPluginOptions = {}): Promise<Hooks> {
  ...
  return {
    ...
    "chat.headers": async (input, output) => {
      ...
      output.headers.originator = "worldapp"
      output.headers["User-Agent"] = `worldapp/${InstallationVersion} (${os.platform()} ${os.release()}; ${os.arch()})`
